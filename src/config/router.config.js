      ...
      // parking
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: { title: '通道信息', keepAlive: true, permission: [ 'user' ] }
          },
          {
            path: 'gate',
            name: 'gate',
            component: () => import('@/views/parking/gate/Gate'),
            meta: { title: '门禁信息', keepAlive: true, permission: [ 'user' ] }
          },
          {
            path: 'org',
            name: 'org',
            component: () => import('@/views/parking/org/Org'),
            meta: { title: '企业机构', keepAlive: true, permission: [ 'user' ] }
          },
          {
            path: 'publicArea',
            name: 'publicArea',
            component: () => import('@/views/parking/publicArea/PublicArea'),
            meta: { title: '公共区域', keepAlive: true, permission: [ 'user' ] }
          }
        ]
      }
    ]
